...
write.table(df.time4, "~/git/caisar/output/Nonconvex_time1.txt", sep = ",")
write.table(df.time5, "~/git/caisar/output/Nonconvex_time2.txt", sep = ",")
write.table(df.time6, "~/git/caisar/output/Nonconvex_time3.txt", sep = ",")
```