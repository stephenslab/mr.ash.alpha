...
```{r fig1}
dat1 = readRDS("results/Experiment_2_Nonconvex_SparseNormal.RDS")
sdat = data.frame()
for (i in 1:5) {
...
```{r fig3}
dat1 = readRDS("results/Experiment_2_Nonconvex_SparseT.RDS")
sdat = data.frame()
for (i in 1:5) {
  dmat       = matrix(dat1[[i]]$nrmse, 20, 5)
  nrmse      = colMeans(dmat)
...
```{r fig5}
dat1 = readRDS("results/Experiment_2_Nonconvex_SparseLaplace.RDS")
sdat = data.frame()
for (i in 1:5) {
  dmat       = matrix(dat1[[i]]$nrmse, 20, 5)
  nrmse      = colMeans(dmat)
