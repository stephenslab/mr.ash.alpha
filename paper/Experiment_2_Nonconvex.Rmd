...
```{r bimodal10, eval = FALSE}
pred32 = matrix(0,20,5)
t32    = matrix(0,20,5)
null32 = double(20)
best32 = double(20)
sigma32 = double(20)
...
```{r bimodal20, eval = FALSE}
pred33 = matrix(0,20,5)
t33    = matrix(0,20,5)
null33 = double(20)
best33 = double(20)
sigma33 = double(20)
...
```{r bimodal40, eval = FALSE}
pred34 = matrix(0,20,5)
t34    = matrix(0,20,5)
null34 = double(20)
best34 = double(20)
sigma34 = double(20)
...
numlist = c(11,12,13,14,21,22,23,24,31,32,33,34)
dat = list()
